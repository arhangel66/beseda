...
swift build --package-path "$ROOT" -c release --product Podushka
...
gh release create "$TAG" "$ZIP" --repo "$REPO" --title "Podushka $VERSION" --notes "Podushka $VERSION"
